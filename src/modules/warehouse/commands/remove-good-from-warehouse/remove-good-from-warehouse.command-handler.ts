...
import { RemoveGoodFromWarehouseCommand } from "./remove-good-from-warehouse.command.js";

@CommandHandler(RemoveGoodFromWarehouseCommand)
export class RemoveGoodFromWarehouseCommandHandler implements ICommandHandler<RemoveGoodFromWarehouseCommand> {
    constructor(
