...
import { ReorderJourneyStopsCommand } from "./reorder-journey-stops.command.js";

@CommandHandler(ReorderJourneyStopsCommand)
export class ReorderJourneyStopsCommandHandler implements ICommandHandler<ReorderJourneyStopsCommand> {
    constructor(
