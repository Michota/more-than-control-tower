...
import { LockAvailabilityCommand } from "./lock-availability.command.js";

@CommandHandler(LockAvailabilityCommand)
export class LockAvailabilityCommandHandler implements ICommandHandler<LockAvailabilityCommand> {
    constructor(
    ...
    async execute(cmd: LockAvailabilityCommand): Promise<void> {
