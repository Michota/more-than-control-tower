...
import { RemoveJourneyStopCommand } from "./remove-journey-stop.command.js";

@CommandHandler(RemoveJourneyStopCommand)
export class RemoveJourneyStopCommandHandler implements ICommandHandler<RemoveJourneyStopCommand> {
    constructor(
