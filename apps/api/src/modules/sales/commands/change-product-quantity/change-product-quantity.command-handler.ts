...
export class ChangeProductQuantityCommandHandler implements ICommandHandler<ChangeProductQuantityCommand> {
    constructor(
    ...
    async execute(cmd: ChangeProductQuantityCommand): Promise<void> {
        ...
        order.changeProductQuantity(orderItem, cmd.quantity);
