...
import { CancelJourneyCommand } from "./cancel-journey.command.js";

@CommandHandler(CancelJourneyCommand)
export class CancelJourneyCommandHandler implements ICommandHandler<CancelJourneyCommand> {
    constructor(
    ...
    async execute(cmd: CancelJourneyCommand): Promise<void> {
