...
import { UnassignPositionCommand } from "./unassign-position.command.js";

@CommandHandler(UnassignPositionCommand)
export class UnassignPositionCommandHandler implements ICommandHandler<UnassignPositionCommand> {
    constructor(
