...
export class RemoveProductFromOrderCommandHandler implements ICommandHandler<RemoveProductFromOrderCommand> {
    constructor(
    ...
    async execute(cmd: RemoveProductFromOrderCommand): Promise<void> {
